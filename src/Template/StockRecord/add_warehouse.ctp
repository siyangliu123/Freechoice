    ...
    <div class="form-check row">
        ...
        <div class="col-md-7 col-lg-7">
            <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" id="warehouse-in" name="warehouse" value="in">
                <label class="custom-control-label" for="warehouse-in">Stock In</label>
            </div>
            <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" id="warehouse-out" name="warehouse" value="out">
                <label class="custom-control-label" for="warehouse-out">Stock Out</label>
            </div>
        </div>
    </div>
    ...
    <table id="cigaretteTable" class="table table-hover table-bordered table-centered stock">
        ...
        <?php foreach ($cigarettes as $cigarette): ?>
            <tr class="cigaretteTr">
                ...
                <td><span class="cigaretteStock"><?php echo $cigarette->Cig_warehouse_stock; ?></td>
                <td>
...
<script>
    $(document).ready(function () {
        ...
        $("input[name='warehouse']").change(function () {
            $("input[name='warehouse']").attr("disabled", "disabled");
            if ($("input[name='warehouse']:checked").val() === "in") {
                limitPositive();
            }
            else if ($("input[name='warehouse']:checked").val() === "out") {
                limitNegative();
            }
        ...
        $(".buttonQuantity").on("click", function () {
            ...
            if ($(this).hasClass("minus")) {
                ...
                quantity.val(parseInt(quantity.val()) + 1);
                if($("input[name='warehouse']:checked").val() === "out"){
                    if (parseInt(quantity.val()) > 0) {
        ...
        function limitPositive() {
            $(".cigaretteQuantity").change(function () {
