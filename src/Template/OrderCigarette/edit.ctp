...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $orderCigarette->order_cigarette_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $orderCigarette->order_cigarette_id)]
            )
        ?></li>
...
<div class="orderCigarette form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Order Cigarette') ?></legend>
        <?php
