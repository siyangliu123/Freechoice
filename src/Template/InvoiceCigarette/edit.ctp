...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $invoiceCigarette->invoice_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $invoiceCigarette->invoice_id)]
            )
        ?></li>
...
<div class="invoiceCigarette form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Invoice Cigarette') ?></legend>
        <?php
