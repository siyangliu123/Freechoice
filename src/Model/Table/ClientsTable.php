...
class ClientsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setDisplayField('detail_id');
    ...
    public function validationDefault(Validator $validator)
    {
        $validator
            ->integer('detail_id')
            ->allowEmptyString('detail_id', 'create')
            ->add('detail_id', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);
    ...
    {
        $rules->add($rules->isUnique(['detail_id']));
