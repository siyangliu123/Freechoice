...
class OrdersTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->allowEmptyDateTime('order_date', false);

        $validator
            ->scalar('order_user')
            ->maxLength('order_user', 100)
            ->requirePresence('order_user', 'create')
            ->allowEmptyString('order_user', false);

        $validator
            ->scalar('order_comment')
            ->maxLength('order_comment', 100)
            ->allowEmptyString('order_comment');
